...
public class TestAdapter {
  ...
  public static void main(String[] args) {
    ...
    Client client = new ClientAdapter(c1.getName(),c1.getAddress(),c1);
    ...
    while (ias.hasMoreElements()) {
      ...
      System.out.println("  International Account " + ia.getAccountNumber() + ", currency = " + ia.getCurrency() + ", balance = USD " +
                         ia.showBalanceInUSD());
    }
